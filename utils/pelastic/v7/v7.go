...
// indexName: 索引名
func (v7 *V7) ExistIndex(ctx context.Context, indexName string) (bool, error) {
	// 创建请求对象
...
func (v7 *V7) CreateIndex(ctx context.Context, indexName string, mappings string) error {
	// 创建请求对象
...
// DeleteIndex 删除索引
// indexNames:  索引集
func (v7 *V7) DeleteIndex(ctx context.Context, indexNames []string) error {
	// 构造 DELETE 请求
...
// indexName: 索引名
// bodyContent:  索引数据
func (v7 *V7) Write(ctx context.Context, indexName string, bodyContent interface{}, _id ...string) (string, error) {
	var (
		docId string
	)
	// 指定文档ID
...
// _id: 文档ID
// bodyContent:  索引数据
func (v7 *V7) Update(ctx context.Context, indexName string, _id string, bodyContent interface{}) error {
	retry := 3
...
// indexName:  索引名
// _id: 文档ID
func (v7 *V7) Delete(ctx context.Context, indexName string, _id string) error {
...
// indexName:  索引名
// query:  查询条件,json格式
func (v7 *V7) Search(ctx context.Context, indexName []string, query string) (map[string]interface{}, error) {
